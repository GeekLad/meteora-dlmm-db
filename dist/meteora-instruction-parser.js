...
function parseMeteoraInstruction(transaction, instruction) {
...
function getMeteoraInstructionData(transaction, instruction) {
...
function getPositionAccounts(decodedInstruction, accountMetas) {
    try {
